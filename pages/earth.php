    ...
    <div class="grid">
      ...
      <div class="planet_info planet_top">
        ...
        <p>
          ...
          Old English noun most often spelled eorðe. It has cognates in every
          Germanic language, and their ancestral root has been reconstructed
          as *erþō. In its earliest attestation, the word eorðe was already
          being used to translate the many senses of Latin terra and Greek γῆ
          gē: the ground, its soil, dry land, the human world, the surface of
          the world (including the sea), and the globe itself. As with Roman
          Terra/Tellūs and Greek Gaia, Earth may have been a personified
          goddess in Germanic paganism: late Norse mythology included Jörð
        ...
        <p>
          Occasionally, the name Terra /'tɛrə/ is used in scientific writing
          and especially in science fiction to distinguish humanity's
          inhabited planet from others, while in poetry Tellus /'tɛləs/ has
          ...
          Latinate form Gæa or Gaea (English: /'dʒi:ə/) of the Greek poetic
          name Gaia (Γαῖα; Ancient Greek: [gâi̯.a] or [gâj.ja]) is rare, though
          the alternative spelling Gaia has become common due to the Gaia
          hypothesis, in which case its pronunciation is /'gaiə/ rather than
          the more classical English /'geiə/.
        </p>
      </div>
